...
namespace Online_Game_Store
{
    public partial class Home1 : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con2.Open();
            String f = "select footer_text from Others where other_id=20";
            SqlCommand foot = new SqlCommand(f, con2);
            String footText =foot.ExecuteScalar().ToString();
            LabelFootText.Text = footText;
            con2.Close();
